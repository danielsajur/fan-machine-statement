...
public class FanMachine implements Fan, ModifiableDirection, ModifiableSpeed, Runnable {
    ...
    public Direction changeDirection(){ return direction.changeDirection(); }
